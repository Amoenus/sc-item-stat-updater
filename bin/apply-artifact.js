...
import { readArtifactFile } from '../src/lib/artifact.js';
import { getLogger, setJsonOutput, setLogLevel, shutdownLogger } from '../src/lib/logger.js';
import { applyArtifact } from '../src/lib/loader.js';
...
try {
  ...
  logger.error('Failed to apply artifact', { error: err.message, cause: err.cause?.message });
