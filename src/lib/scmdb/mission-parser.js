 ...
 * @property {Array<any>} [blueprintRewards]
 * @property {Array<{tag?: string}>} [completionTags]
 */
...
/**
 * @param {Array<ScmdbContract>} contracts
 * @returns {ChainData}
 */
...
/**
 * @param {Record<string, any>} blueprintPools
