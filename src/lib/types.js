 ...
 * @property {(row: Record<string, string>, flavorText: string, oldValue: string, targetKey: string) => string} buildValue - Transforms a CSV row into an INI description value
