import { type MemaRowDTO, MemaRowSchema } from '../../schema/mission/mema-rows.schema.js';
import type { ScmdbMemaCacheDTO, ScmdbMergedDTO } from '../../schema/scmdb.schemas.js';

export function buildMemaRows(memaData: ScmdbMemaCacheDTO, mergedData: ScmdbMergedDTO): MemaRowDTO[] {
  const rows: MemaRowDTO[] = [];
