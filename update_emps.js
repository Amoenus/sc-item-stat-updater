...
const CSV_PATH = String.raw`c:\Games\Roberts Space Industries\StarCitizen\LIVE\Data\Localization\english\emps.csv`;
...
for (const [key, idx] of Object.entries(existingKeys)) {
  ...
  if (kl.includes('desc') && kl.includes('emp')) {
...
console.log(`EMPs: Updated ${updatedCount}, Added ${newCount}, Skipped ${skippedCount}`);
console.log('Done!');
