...
const CSV_PATH = String.raw`c:\Games\Roberts Space Industries\StarCitizen\LIVE\Data\Localization\english\qeds.csv`;
...
for (const [key, idx] of Object.entries(existingKeys)) {
  ...
  if (kl.includes('descqdmp_') || kl.includes('descqed_')) {
...
console.log(`QEDs: Updated ${updatedCount}, Added ${newCount}, Skipped ${skippedCount}`);
console.log('Done!');
