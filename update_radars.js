...
const CSV_PATH = String.raw`c:\Games\Roberts Space Industries\StarCitizen\LIVE\Data\Localization\english\radars.csv`;
...
for (const [key, idx] of Object.entries(existingKeys)) {
  ...
  if (kl.includes('desc_radr_') || kl.includes('descradr_')) {
...
console.log(`Radars: Updated ${updatedCount}, Added ${newCount}, Skipped ${skippedCount}`);
console.log('Done!');
