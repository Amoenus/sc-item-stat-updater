...
const CSV_PATH = String.raw`c:\Games\Roberts Space Industries\StarCitizen\LIVE\Data\Localization\english\shields.csv`;
...
for (const [key, idx] of Object.entries(existingKeys)) {
  if (key.toLowerCase().includes('descshld_') || key.toLowerCase().includes('desc_shld_')) {
...
console.log(`Shields: Updated ${updatedCount}, Added ${newCount}, Skipped ${skippedCount}`);
console.log('Done!');
