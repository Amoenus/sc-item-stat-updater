...
const CSV_PATH = String.raw`c:\Games\Roberts Space Industries\StarCitizen\LIVE\Data\Localization\english\tractor_beams.csv`;
...
for (const [key, idx] of Object.entries(existingKeys)) {
  ...
  if (kl.includes('desc') && kl.includes('tractorbeam')) {
...
console.log(`Tractor Beams: Updated ${updatedCount}, Added ${newCount}, Skipped ${skippedCount}`);
console.log('Done!');
